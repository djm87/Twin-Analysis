...
%   IDCT is a DCT of modified Type III
...
%   See also IDCTT.
%
%   New behavior (6/19/08): if this function is called without any
%   arguments, the output is the number of function calls since
%   the last reset.  The calls are reset everytime this is queried.
%
%   Question: what are the FFTpack conventions?
...
if nargin == 0,
    b = nCalls;
%     if nargout ==0 fprintf('Number of DCT calls is %d\n',b); end
    nCalls = 0;
    return
end
nCalls = nCalls + 1;
