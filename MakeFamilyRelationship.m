function [FamilyMatrix,EdgeMatrix,FamilyRelationList,eVotesSummed]=...
...
%==========================================================================
        ...
        %Similar to Family except for each edge and Edgematrix 3d dimension
        %contains 1: parent child, 2: index of edge, 3: family of parent,
        %4: family of child
...
function EdgeMatrix = buildEdgeMatrix(nId,ePairs,eFamily,Parent)
    EdgeMatrix=zeros(length(nId),length(nId),4,'uint8');
