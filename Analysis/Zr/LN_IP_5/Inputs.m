...
% EBSD import 
dataDir='E:\Dropbox\Research\Source\Twin-Analysis\Data\Rods Data\Zr-LN-IP-5\LN-IP-05-6'
% EBSDinterface='mat';
% EBSDinterface='osc';
EBSDinterface='ang';
EBSDfname = fullfile(dataDir,strcat('Zr_LN_5pct_06.',EBSDinterface));
...
meanMistol=6*degree; %needs to be slight larger (like Rod noted)
