...
groups=unique(G_clust.Nodes.Group(G_clust.Nodes.FamilyID>3));
...
plotNeighbors=true;
enforceClusterOnlyMod=false;
% [G_clust,~,~] = ClusterEditor(groups(17:end),G_clust,grains,mergedGrains,value,0,plotNeighbors,enforceClusterOnlyMod); 
...
groups=unique([3389 3388 3404 3379 3198 3199])
