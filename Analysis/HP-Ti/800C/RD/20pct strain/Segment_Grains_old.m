...
groups=unique(G_clust.Nodes.Group(G_clust.Nodes.FamilyID>11));
...
% text(mergedGrains,int2str(mergedGrains.id));hold off;
%%
groups=unique([1038,995,1113,1058,1140,1105,1044,641,863,762,826,797,776,741,824,744,737,757,242,818,813,799,772,864,964,930,900,890,842,784,915,878,1038,943,786,1110,1138,1002,1054])
value=grains.meanOrientation;
plotNeighbors=true;
enforceClusterOnlyMod=false;
% [G_clust,~,~] = ClusterEditor(groups,G_clust,grains,mergedGrains,value,0,plotNeighbors,enforceClusterOnlyMod); 
