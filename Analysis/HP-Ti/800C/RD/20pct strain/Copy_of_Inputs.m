...
% Crystal symmetry
CS = {'notIndexed',crystalSymmetry('622', [3.232 3.232 5.147],...
    'X||a', 'Y||b*', 'Z||c', 'mineral', 'Zr', 'color', 'light blue')};

% EBSD import 
dataDir='E:\Dropbox\Research\Source\Twin-Analysis\Data\Rods Data\Zr-LN-IP-10\Scan2'
% EBSDinterface='mat';
% EBSDinterface='osc';
EBSDinterface='ang';
EBSDfname = fullfile(dataDir,strcat('LN_IP_10.',EBSDinterface));
