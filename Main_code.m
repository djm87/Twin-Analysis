...
G_Complete.Nodes.Type>0
selection=G_Complete.Nodes.Id(G_Complete.Nodes.Type>0);

[omega,a,b] = fitEllipse(grains(selection));
figure;
plot(grains,grains.meanOrientation)
hold on
plotEllipse(grains(selection).centroid,a,b,omega,'lineColor','w','linewidth',2)
hold off

ebsd2=ebsd;


%% Prototype removing a line 
Gid1=402
Gid2=399
uc= ebsd.unitCell 
xdist = sqrt(3)*sqrt((uc(1,1)-uc(4,1))^2+(uc(1,2)-uc(4,2))^2)
...
figure;plot(ebsd2,ebsd2.orientations)

%% Call reconstruction 
[ebsd2,G_Complete] = fragmentReconstruction(G_Complete,ebsd,grains)
% figure;plot(ebsd2,ebsd2.orientations)
grains2=calcGrains(ebsd2)
